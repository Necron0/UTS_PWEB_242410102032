...
<div class="container flex justify-center items-center mx-auto">
    <div class="login border p-3 rounded-4xl shadow-lg w-100 mt-10 flex items-center justify-center bg-[#14213d] text-white">
        <form action="/dashboard" method="GET" class="flex flex-col w-96">
            <h1 class="text-xl flex justify-center text-[#fca311]">Login</h1>
            <div>
                ...
                <button>
                    <input type="submit" value="Login" class="bg-[#fca311] text-white font-bold py-2 px-4 rounded-lg mt-4 hover:bg-yellow-600 transition delay-75 duration-300 ease-in-out w-full">
                </button>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\mini-project-laravel\resources\views/login.blade.php ENDPATH**/ ?>